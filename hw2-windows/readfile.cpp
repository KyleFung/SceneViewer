            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                if (cmd == "light") {
                    if (numused == numLights) { // No more Lights 
                        ...
                        if (validinput) {
							int base = 4 * numused;
							lightposn[base + 0] = values[0];
							lightposn[base + 1] = values[1];
							lightposn[base + 2] = values[2];
							lightposn[base + 3] = values[3];
							lightcolor[base + 0] = values[0+4];
							lightcolor[base + 1] = values[1+4];
							lightcolor[base + 2] = values[2+4];
							lightcolor[base + 3] = values[3+4];
                            ++numused;
                        }
                    }
                }
                ...
                // Note that no transforms/stacks are applied to the colors. 
                    ...
                    if (validinput) {
						...
						mat4 rotate4 = mat4(Transform::rotate(values[3], axis));
						transfstack.top() = transfstack.top() * rotate4;
                    }
                }
